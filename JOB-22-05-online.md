...
小结: 绿 18 / 红 3 / 灰(N/A) 12

## 五端 index：主仓库指向 vs 线上实际
| 端 | 主仓库 index 指向(期望) | 线上实际指向 |
|---|---|---|
| student | maxhouse_student_portal_v400 | maxhouse_student_portal_v400 |
| partner | maxhouse-partner-portal-v170 | maxhouse-partner-portal-v170 |
| school | maxhouse-school-portal-v235 | maxhouse-school-portal-v235 |
...
| 步骤 | 期望 | 实际 | 判 |
|---|---|---|---|
| ① [VER] student index 指向主仓库版本 | maxhouse_student_portal_v400.html | 线上==主仓库 (用时 22s) | 绿 |
| ① [VER] partner index 指向主仓库版本 | maxhouse-partner-portal-v170.html | 线上==主仓库 (用时 0s) | 绿 |
| ① [VER] school index 指向主仓库版本 | maxhouse-school-portal-v235.html | 线上==主仓库 (用时 0s) | 绿 |
...
| ④ student 版本文件有 Link | Link 头存在 | status 200, 有 Link=<https://uexgzwfambanvhdhxome.supabase.co>; re… | 绿 |
...
| ④ partner 版本文件有 Link | Link 头存在 | status 200, 有 Link=<https://uexgzwfambanvhdhxome.supabase.co>; re… | 绿 |
...
| ④ school 版本文件有 Link | Link 头存在 | status 200, 有 Link=<https://uexgzwfambanvhdhxome.supabase.co>; re… | 绿 |
...
| ③ [VER] partner console == 主仓库版本 (maxhouse-partner-portal-v170) | console 打印与主仓库 index 同版 | 命中 | 绿 |
...
· [绿] ① [VER] student index 指向主仓库版本 — 期望: maxhouse_student_portal_v400.html | 实际: 线上==主仓库 (用时 22s)
· 轮询 partner index: https://www.maxhouses.net/partner-portal/ → 期待指向主仓库当前版本 maxhouse-partner-portal-v170.html
· [绿] ① [VER] partner index 指向主仓库版本 — 期望: maxhouse-partner-portal-v170.html | 实际: 线上==主仓库 (用时 0s)
· 轮询 school index: https://www.maxhouses.net/school-portal/ → 期待指向主仓库当前版本 maxhouse-school-portal-v235.html
· [绿] ① [VER] school index 指向主仓库版本 — 期望: maxhouse-school-portal-v235.html | 实际: 线上==主仓库 (用时 0s)
...
· [绿] ④ student 版本文件有 Link — 期望: Link 头存在 | 实际: status 200, 有 Link=<https://uexgzwfambanvhdhxome.supabase.co>; re…
...
· [绿] ④ partner 版本文件有 Link — 期望: Link 头存在 | 实际: status 200, 有 Link=<https://uexgzwfambanvhdhxome.supabase.co>; re…
...
· [绿] ④ school 版本文件有 Link — 期望: Link 头存在 | 实际: status 200, 有 Link=<https://uexgzwfambanvhdhxome.supabase.co>; re…
...
· partner1 已真登线上中介端。
· [绿] ③ [VER] partner console == 主仓库版本 (maxhouse-partner-portal-v170) — 期望: console 打印与主仓库 index 同版 | 实际: 命中
